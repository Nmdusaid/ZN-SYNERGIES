    ...
    <footer className="bg-background pt-32 pb-16 border-t border-white/5 px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          <div className="space-y-10">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 border border-primary/40 flex items-center justify-center rotate-45">
                <Globe className="text-primary -rotate-45" size={16} />
              </div>
          ...
          <div>
            <h4 className="text-primary text-[10px] uppercase tracking-[0.3em] font-bold mb-10">Direct Contact</h4>
          ...
          <div>
            <h4 className="text-primary text-[10px] uppercase tracking-[0.3em] font-bold mb-10">Newsletter</h4>
            ...
            <div className="flex border-b border-white/10 pb-2">
              ...
              />
              <button className="text-primary font-bold text-[10px] tracking-widest">JOIN</button>
            </div>
          </div>
        </div>
